...
public class AadharModel {
    ...
    public static final String MODEL_PATH = "22082019_Aadhaar.tflite";
...
//    public static boolean readyForFRAnalysis = false;
    ...
    public AadharModel(AssetManager assetManager) throws IOException, Exception {
...
//        tfliteOptions.setNumThreads(2);
        ...
        AadhaarAnalysis.readyForDocAnalysis = true;

    }

    public AadharModel(File modelFilePath, int IMAGE_WIDTH, int IMAGE_HEIGHT) throws IOException, Exception {
